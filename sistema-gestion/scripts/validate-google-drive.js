...
console.log(
  `   📁 Archivo de credenciales: ${
    hasCredentialsFile ? "✅ Encontrado" : "❌ No encontrado"
  }`
);
console.log(
  `   🌍 Variables de entorno: ${
    hasEnvVars ? "✅ Configuradas" : "❌ No configuradas"
  }`
);
...
if (!hasCredentialsFile && !hasEnvVars) {
  ...
  console.log("\n📝 Para configurar:");
  console.log(
    "   1. Coloca el archivo JSON de credenciales en: ./credentials/google-drive-service-account.json"
  );
...
try {
  ...
  if (isValid) {
    ...
    console.log(
      "   La funcionalidad de carga de imágenes móvil está lista para usar.\n"
    );
  } else {
